...
def run(playwright: Playwright) -> None:
    ...
    expectmethods.login(locator='[data-test="username"]', login='standard_user', password='secret_sauce')
    ...
    loginpage.select(option_selector='[data-test="product-sort-container"]', option_value='lohi', modifier_value=5)
